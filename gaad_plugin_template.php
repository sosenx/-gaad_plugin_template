...
if ( !defined( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_DIR' ) )           define( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_DIR',                  	plugin_dir_path( __FILE__) );
if ( !defined( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_VENDOR_DIR' ) )    define( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_VENDOR_DIR',           	GAAD_PLUGIN_TEMPLATE_NAMESPACE . GAAD_PLUGIN_TEMPLATE_DIR .'/vendor' );

if ( !defined( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_AUTOLOAD' ) )      define( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_AUTOLOAD',             	GAAD_PLUGIN_TEMPLATE_NAMESPACE . GAAD_PLUGIN_TEMPLATE_VENDOR_DIR . '/autoload.php');
if ( !defined( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_THEME_FILES_DIR' ) ) define( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_THEME_FILES_DIR',      	GAAD_PLUGIN_TEMPLATE_NAMESPACE . GAAD_PLUGIN_TEMPLATE_DIR . 'theme_files' );
if ( !defined( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_APP_TEMPLATES_DIR' ) ) 		define( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_APP_TEMPLATES_DIR', 		GAAD_PLUGIN_TEMPLATE_NAMESPACE . GAAD_PLUGIN_TEMPLATE_DIR . 'templates' );
if ( !defined( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_DIR') )                		define( GAAD_PLUGIN_TEMPLATE_NAMESPACE . 'GAAD_PLUGIN_TEMPLATE_DIR',               		GAAD_PLUGIN_TEMPLATE_NAMESPACE . GAAD_PLUGIN_TEMPLATE_DIR . '/' . GAAD_PLUGIN_TEMPLATE_NAME );
